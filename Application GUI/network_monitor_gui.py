...
# # # # # # #         filename_format.setForeground(QColor("#FF1493"))
# # # # # # #         self.highlighting_rules.append((r'Filename: .+', filename_format))
...
# # # # # # # # Packet Class with 7 Layers, Payload, and Filename
# # # # # # # class Packet:
# # # # # # #     def __init__(self, number: str, timestamp: str, src_ip: str, dst_ip: str, protocol: str, size: str, delta_time: str, filename: str, details: dict):
# # # # # # #         self.number = number
# # # # # # #         self.timestamp = timestamp
# # # # # # #         self.src_ip = src_ip
# # # # # # #         self.dst_ip = dst_ip
...
# # # # # # #         self.filename = filename  # New field for filename
# # # # # # #         self.details = details  # Dictionary for sections, layers, and payload
...
# # # # # # #     def columnCount(self, index) -> int:
# # # # # # #         return 8  # Increased to 8 columns to include Filename
...
# # # # # # #             return [packet.number, packet.timestamp, packet.src_ip, packet.dst_ip, 
# # # # # # #                    packet.protocol or "Unknown", packet.size or "0", 
# # # # # # #                    packet.delta_time or "0.000000", packet.filename or "N/A"][index.column()]
# # # # # # #         if role == Qt.BackgroundRole:
# # # # # # #             packet = self.packets[index.row()]
# # # # # # #             color = QColor(255, 255, 255)
# # # # # # #             if packet.protocol == "TCP":
...
# # # # # # #         if role != Qt.DisplayRole:
# # # # # # #             return None
# # # # # # #         headers = ["Packet #", "Timestamp", "Source IP", "Destination IP", "Protocol", "Size", "Delta Time", "Filename"]
# # # # # # #         return headers[section] if orientation == Qt.Horizontal else str(section + 1)
...
# # # # # # #                         elif line.startswith("Protocol: "):
# # # # # # #                             protocol = line.split("Protocol: ", 1)[1].strip()
# # # # # # #                     elif current_section == "File Information":
...
# # # # # # #                 if timestamp:
# # # # # # #                     packet = Packet(packet_number, timestamp, src_ip, dst_ip, protocol, size, delta_time, filename, details)
# # # # # # #                     self.packets.append(packet)
...
# # # # # # #             if any(search_text in str(val).lower() for val in [packet.timestamp, packet.src_ip, packet.dst_ip, 
# # # # # # #                                                               packet.protocol, packet.size, packet.delta_time, 
# # # # # # #                                                               packet.filename, *packet.details.values()]):
# # # # # # #                 filtered_packets.append(packet)
# # # # # # #         for log in self.file_logs:
# # # # # # #             if any(search_text in str(val).lower() for val in [log.timestamp, log.operation, log.file_path, log.details]):
# # # # # # #                 filtered_logs.append(log)
...
# # # # # #         # Filename
# # # # # #         filename_format = QTextCharFormat()
# # # # # #         filename_format.setForeground(QColor("#8B008B"))
# # # # # #         self.highlighting_rules.append((r'Filename: .+', filename_format))
...
# # # # # #         self.parent.file_logs.append(log)
# # # # # #         self.parent.file_log_model.layoutChanged.emit()
# # # # # #         # Update the latest packet with the filename
# # # # # #         if self.parent.packets and operation in ["CREATE", "UPDATE"]:
# # # # # #             filename = os.path.basename(file_path)
# # # # # #             self.parent.packets[-1].filename = filename
# # # # # #             self.parent.packets[-1].details["File Information"] = f"Filename: {filename}"
# # # # # #             self.parent.packet_model.layoutChanged.emit()
...
# # # # # #                         protocol = line.split("Protocol: ", 1)[1].strip()
# # # # # #                 elif current_section == "File Information":
# # # # # #                     if line.startswith("Filename negatywn"):
# # # # # #                         filename = line.split("Filename: ", 1)[1].strip()
# # # # # #                 elif current_section:
# # # # # #                     details[current_section].append(line)
...
# # # # #         filename_format = QTextCharFormat()
# # # # #         filename_format.setForeground(QColor("#FF1493"))
# # # # #         self.highlighting_rules.append((r'Application Data: .*\.txt\b', filename_format))
...
# # # # #         self.size = size
# # # # #         self.delta_time = delta_time
# # # # #         self.filename = filename  # Field for filename
# # # # #         self.details = details  # Dictionary for sections, layers, and payload
...
# # # # #     def columnCount(self, index) -> int:
# # # # #         return 8  # Includes Filename column
...
# # # # #                         elif line.startswith("Protocol: "):
# # # # #                             protocol = line.split("Protocol: ", 1)[1].strip()
# # # # #                     elif current_section == "Layer 7 - Application":
# # # # #                         if line.startswith("Application Data: "):
# # # # #                             app_data = line.split("Application Data: ", 1)[1].strip()
# # # # #                             # Extract filename (e.g., sample1c1101.txt) from Application Data
# # # # #                             filename_match = re.search(r'([a-zA-Z0-9_-]+\.txt)\b', app_data)
# # # # #                             if filename_match:
...
# # # # #         program = r"C:\Users\kmit\Desktop\name\x64\Debug\name.exe"
# # # # #         if not os.path.exists(program):
# # # # #             QMessageBox.critical(self, "Error", f"Executable not found at {program}")
# # # # #             return []
# # # # #         process = QProcess(self)
# # # # #         process.start(program)
# # # # #         if not process.waitForStarted(3000):
# # # # #             error = process.errorString()
# # # # #             QMessageBox.critical(self, "Error", f"Failed to start name.exe: {error}")
# # # # #             return []
# # # # #         process.waitForReadyRead(5000)
# # # # #         output = process.readAllStandardOutput().data().decode("utf-8", errors="ignore")
# # # # #         process.kill()
...
# # # # #                 interfaces.append((int(index), desc.strip()))
# # # # #         if not interfaces:
# # # # #             QMessageBox.warning(self, "Warning", "No network interfaces found.")
# # # # #         return interfaces
...
# # # #                         if line.startswith("Application Data: "):
# # # #                             app_data = line.split("Application Data: ", 1)[1].strip()
# # # #                             # Debug: Log the raw Application Data
# # # #                             with open(r"C:\Logs\debug.log", "a", encoding="utf-8") as f:
# # # #                                 f.write(f"Packet #{packet_number} Application Data: {app_data}\n")
# # # #                             # Extract filename (e.g., sample1c1101.txt) from Application Data
# # # #                             filename_match = re.search(r'([a-zA-Z0-9_-]+\.[a-zA-Z0-9]+)', app_data)
# # # #                             if filename_match:
# # # #                                 filename = filename_match.group(1)
# # # #                                 # Debug: Log the extracted filename
# # # #                                 with open(r"C:\Logs\debug.log", "a", encoding="utf-8") as f:
# # # #                                     f.write(f"Packet #{packet_number} Extracted Filename: {filename}\n")
# # # #                     elif current_section:
# # # #                         details[current_section].append(line)
...
# # #         filename_format = QTextCharFormat()
# # #         filename_format.setForeground(QColor("#FF1493"))
# # #         self.highlighting_rules.append((r'Application Data: [a-zA-Z0-9_-]+\.txt\b', filename_format))
...
# # #     def log_event(self, operation: str, file_path: str, details: str) -> None:
# # #         timestamp = time.strftime("%Y-%m-dd %H:%M:%S")
# # #         color = QColor(0, 0, 0)
# # #         log = FileLog(timestamp, operation, file_path, details, color)
# # #         log_dir = r"C:\Logs"
# # #         if not os.path.exists(log_dir):
...
# # #                             with open(r"C:\Logs\debug.log", "a", encoding="utf-8") as f:
# # #                                 f.write(f"Packet #{packet_number} Application Data: {app_data}\n")
# # #                             # Extract filename (e.g., sample1c1101.txt), stopping after .txt
# # #                             filename_match = re.search(r'([a-zA-Z0-9_-]+\.txt)(?=\b|[^a-zA-Z0-9_.-])', app_data)
# # #                             if filename_match:
# # #                                 filename = filename_match.group(1)
# # #                                 # Debug: Log the extracted filename
# # #                                 with open(r"C:\Logs\debug.log", "a", encoding="utf-8") as f:
...
# # #             QMessageBox.warning(self, "Error", f"Failed to load logs: {str(e)}")
# # #             with open(r"C:\Logs\debug.log", "a", encoding="utf-8") as f:
# # #                 f.write(f"[{time.strftime('%Y-%m-dd %H:%M:%S')}] Error loading logs: {str(e)}\n")
...
# #         filename_format = QTextCharFormat()
# #         filename_format.setForeground(QColor("#FF1493"))
# #         self.highlighting_rules.append((r'Application Data: [a-zA-Z0-9_-]+\.txt(?=\b|[^a-zA-Z0-9_.-])', filename_format))
...
# #                                 f.write(f"Packet #{packet_number} Application Data: {app_data}\n")
# #                             # Extract filename (e.g., sample1c1101.txt), stopping after .txt
# #                             filename_match = re.search(r'([a-zA-Z0-9_-]+\.txt)', app_data)
# #                             if filename_match:
# #                                 # Get the matched filename and ensure no trailing characters
# #                                 filename = filename_match.group(1)
# #                                 # Verify the match ends with .txt to avoid trailing content
...
# #                                     filename = "N/A"
# #                                     with open(r"C:\Logs\debug.log", "a", encoding="utf-8") as f:
# #                                         f.write(f"Packet #{packet_number} Invalid Filename Format\n")
# #                     elif current_section:
# #                         details[current_section].append(line)
...
#         # Ensure all sections are displayed, including Layer 7
#         section_order = [
#             "Timing Information",
#             "Layer 1 - Physical",
#             "Layer 2 - Data Link",
...
#                     content = packet.details[section]
#                     full_details += f"[{section}]\n{content}\n\n"
#             self.details_text.setText(full_details.strip() or "No details available")
